...
class CreateLogAktifitasTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared("
            ...
            RETURNS trigger AS $$
            BEGIN
                INSERT INTO log_aktifitas(users_id,aksi, waktu,tipe) VALUES (NEW.users_id,  CONCAT('Menambahkan','Catatan','Perjalanan','Di','lokasi',NEW.lokasi) as CONCAT_CREATE,now(), 1);
                RETURN null;
            END
            $$ LANGUAGE plpgsql;
