                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <img src="{{ asset('landing') }}/assets/images/slider-dec.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="right-image">
                        <img src="{{ asset('landing') }}/assets/images/about-right-dec.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="client-content">
                                                                    ...
                                                                    <div class="down-content">
                                                                        <img src="{{ asset('landing')}}/assets/images/client-image.jpg" alt="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="footer-widget">
                                            ...
                                            <div class="logo">
                                                <img src="{{ asset('landing')}}/assets/images/white-logo.png" alt="">
                                            </div>
